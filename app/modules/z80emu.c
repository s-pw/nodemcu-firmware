...
int __attribute__((section(".iram0.text"))) Z80NonMaskableInterrupt (Z80_STATE *state, void *context)
{
	int	elapsed_cycles;
...
int __attribute__((section(".iram0.text"))) Z80Emulate (Z80_STATE *state, int number_cycles, void *context)
{
